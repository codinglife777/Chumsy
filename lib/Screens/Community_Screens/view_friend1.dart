...
class ViewFriendProfile1 extends StatefulWidget {
  const ViewFriendProfile1({
    super.key,
    required this.dp,
  ...
  @override
  State<ViewFriendProfile1> createState() => _ViewFriendProfile1State();
}

class _ViewFriendProfile1State extends State<ViewFriendProfile1> {
  @override
