...
import 'package:chumsy/constants/globals.dart' as globals;
...
class _ProfileNameState extends State<ProfileName> {
  ...
  void createAccount() {
    ...
    globals.g_userName = _txtUserName.text;
    globals.g_phoneNumber = _txtPhoneNumber.text;

    Navigator.push(context,
        CupertinoPageRoute(builder: (context) => const VerificationCode()));
